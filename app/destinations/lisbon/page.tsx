...
export const metadata: Metadata = {
    ...
    description: "Complete group travel guide for Lisbon: itinerary, real prices, best neighbourhoods and insider tips. PayaGo AI plans the full trip in 30 seconds.",
    openGraph: {
        title: "Lisbon Group Travel Guide 2026 | PayaGo",
        description: "Group travel guide for Lisbon with real prices. AI-planned in 30 seconds.",
