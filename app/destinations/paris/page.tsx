...
export const metadata: Metadata = {
    ...
    description: "Complete group travel guide for Paris: itinerary, real prices, best neighbourhoods and insider tips. PayaGo AI plans the full trip in 30 seconds.",
    openGraph: {
        title: "Paris Group Travel Guide 2026 | PayaGo",
        description: "Group travel guide for Paris with real prices. AI-planned in 30 seconds.",
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <div className="relative h-64 overflow-hidden">
                <img src="/luxury-travel-destination-aerial-view-of-tropical-.jpg" alt="Paris travel" className="w-full h-full object-cover" />
            ...
            <div className="max-w-4xl mx-auto px-6 py-16 text-center">
                <p className="text-slate-600 text-lg mb-8">
                    Full guide coming soon. PayaGo AI already knows Paris inside out — get early access and let the AI build your group itinerary in 30 seconds.
                </p>
                <Link href="/#early-access" className="inline-flex items-center gap-2 bg-gradient-to-r from-[#C9A962] to-[#E5C77D] text-[#1a1a0e] px-8 py-4 rounded-xl font-semibold hover:opacity-90 transition-opacity">
                    Plan a Paris Trip — Free <ArrowRight className="w-4 h-4" />
                </Link>
