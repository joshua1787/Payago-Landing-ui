        ...
        <main className="min-h-screen bg-[#04060A]">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-16 pb-24">
                ...
                <div className="space-y-8 text-white/75 leading-relaxed text-lg">
                    ...
                    <h2 className="text-2xl font-bold text-white mt-12 mb-4">The cost categories and where fights happen</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-4 my-6">
                        {[
                            ...
                            <div key={item.cat} className="p-4 rounded-xl bg-white/[0.03] border border-white/5">
                                <div className="text-white font-semibold text-sm mb-2">{item.cat}</div>
                                <div className="text-white/50 text-xs mb-2">{item.examples}</div>
                                <div className="text-[#FF6B6B] text-xs leading-relaxed">{item.issue}</div>
                            </div>
                        ))}
                    </div>

                    <h2 className="text-2xl font-bold text-white mt-12 mb-4">The 4 methods — ranked by fairness</h2>
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={item.rank} className="flex gap-4 p-5 rounded-xl bg-white/[0.02] border border-white/5">
                                ...
                                <div>
                                    <div className="text-white font-semibold text-sm mb-1">{item.method}</div>
                    ...
                    <h2 className="text-2xl font-bold text-white mt-12 mb-4">The conversation to have before the trip</h2>
                    ...
                    <div className="mt-12 p-6 rounded-2xl bg-[#C9A962]/8 border border-[#C9A962]/20">
                        <p className="text-white font-semibold mb-2">Plan your next group trip — payments sorted automatically.</p>
                        <p className="text-white/60 text-sm mb-4">AI builds the itinerary, your group votes, everyone pays their share. Launching April 2026.</p>
