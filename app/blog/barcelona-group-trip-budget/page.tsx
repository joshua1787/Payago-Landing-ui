    ...
    return (
        <main className="min-h-screen bg-[#04060A]">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-16 pb-24">
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-10 leading-tight text-white">Barcelona Group Trip: What It Actually Costs in 2026</h1>
                ...
                <div className="space-y-8 text-white/75 leading-relaxed text-lg">
                    ...
                    <h2 className="text-2xl font-bold text-white mt-12 mb-4">Flights: what to pay, when to book</h2>
                    ...
                    <h2 className="text-2xl font-bold text-white mt-12 mb-4">Hotel costs by neighbourhood</h2>
                    ...
                    <h2 className="text-2xl font-bold text-white mt-12 mb-4">Sample 5-day budget for 6 people</h2>
                    <div className="overflow-hidden rounded-xl border border-white/5 my-6">
                        <table className="w-full text-sm">
                            ...
                            <tbody className="text-white/60">
                                <tr key="0" className="border-b border-white/5 last:border-0"><td className="px-4 py-3 text-white/80 text-sm">Return flights (EasyJet, 8 weeks ahead)</td><td className="px-4 py-3 text-[#C9A962] font-semibold text-sm">£75 pp</td><td className="px-4 py-3 text-white/40 text-xs">Total: £450</td></tr>
                        <tr key="1" className="border-b border-white/5 last:border-0"><td className="px-4 py-3 text-white/80 text-sm">Hotel 5 nights (Eixample, mid-range)</td><td className="px-4 py-3 text-[#C9A962] font-semibold text-sm">£90/room/night</td><td className="px-4 py-3 text-white/40 text-xs">Total: £1,350 (3 twin rooms)</td></tr>
                        <tr key="2" className="border-b border-white/5 last:border-0"><td className="px-4 py-3 text-white/80 text-sm">Food & drink (5 days)</td><td className="px-4 py-3 text-[#C9A962] font-semibold text-sm">£50–80/day/person</td><td className="px-4 py-3 text-white/40 text-xs">Total: £1,500–2,400</td></tr>
                        <tr key="3" className="border-b border-white/5 last:border-0"><td className="px-4 py-3 text-white/80 text-sm">Activities (Sagrada, Güell, museums)</td><td className="px-4 py-3 text-[#C9A962] font-semibold text-sm">£30–50 pp</td><td className="px-4 py-3 text-white/40 text-xs">Total: £180–300</td></tr>
                        <tr key="4" className="border-b border-white/5 last:border-0"><td className="px-4 py-3 text-white/80 text-sm">Transport (T-10 cards + airport)</td><td className="px-4 py-3 text-[#C9A962] font-semibold text-sm">£20 pp</td><td className="px-4 py-3 text-white/40 text-xs">Total: £120</td></tr>
                            </tbody>
                        </table>
                    </div>
