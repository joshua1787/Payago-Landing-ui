    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-16 pb-24">
                ...
                <h1 className="text-4xl md:text-5xl font-bold mb-10 leading-tight text-slate-900">Tokyo Group Trip Itinerary: 7 Days, Real Costs & Insider Tips (2026)</h1>
                ...
                <div className="space-y-8 text-white/75 leading-relaxed text-lg">
                    ...
                    <div className="overflow-hidden rounded-xl border border-slate-100 my-6">
                        ...
                        <tr key="1" className="border-b border-slate-100 last:border-0"><td className="px-4 py-3 text-slate-600 text-sm">Hotel 7 nights (per person, shared twin)</td><td className="px-4 py-3 text-[#C9A962] font-semibold text-sm">£180–420</td><td className="px-4 py-3 text-slate-500 text-xs">Shinjuku Granbell ★★★★ to Park Hyatt</td></tr>
