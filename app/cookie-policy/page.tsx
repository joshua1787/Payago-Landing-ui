    ...
    return (
        <main className="min-h-screen bg-[#04060A]">
            ...
            <div className="max-w-3xl mx-auto px-6 pt-16 pb-24">
                ...
                <p className="text-white/40 text-sm mb-12">PayaGo Ltd · Company No. 16971574 · Registered in England & Wales</p>

                <div className="space-y-10 text-white/70 leading-relaxed text-base">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold text-white mb-4">What cookies we use</h2>
                                    ...
                                    <table className="w-full text-xs">
                                        <thead>
                                            <tr className="border-b border-white/5 bg-white/[0.02]">
                                                <th className="text-left px-4 py-2.5 text-white/30 font-medium">Cookie</th>
                                                <th className="text-left px-4 py-2.5 text-white/30 font-medium">Purpose</th>
                                                <th className="text-left px-4 py-2.5 text-white/30 font-medium">Duration</th>
                                                <th className="text-left px-4 py-2.5 text-white/30 font-medium">Provider</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {type.examples.map((cookie, i) => (
                                                <tr key={i} className="border-b border-white/5 last:border-0">
                                                    <td className="px-4 py-2.5 text-white/70 font-mono">{cookie.name}</td>
                                                    <td className="px-4 py-2.5 text-white/50">{cookie.purpose}</td>
                                                    <td className="px-4 py-2.5 text-white/40">{cookie.duration}</td>
                                                    <td className="px-4 py-2.5 text-white/40">{cookie.provider}</td>
                                                </tr>
                                            ))}
                                        </tbody>
                                    </table>
