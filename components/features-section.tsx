                                    ...
                                    <div className="flex items-start gap-3.5 mb-3">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                {feature.tag && (
                                                    <span className="px-2 py-0.5 rounded-full bg-slate-100 text-[10px] text-slate-500 uppercase tracking-wider whitespace-nowrap">
                                                        {feature.tag}
                                                    </span>
                                                )}
                                            </div>
                                            <p className="text-[13px] text-slate-500 leading-[1.7]">{feature.description}</p>
                                        </div>
                                    </div>
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-[14px] font-bold text-slate-700 mb-1.5 group-hover:text-slate-900 transition-colors duration-300">{feature.title}</h3>
                                        <p className="text-[12px] text-slate-400 leading-[1.7] group-hover:text-slate-500 transition-colors duration-300">{feature.description}</p>
                                    </div>
                                </div>
                            </div>
                        )
